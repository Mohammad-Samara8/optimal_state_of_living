...
class UserChangePersonalSetting extends StatefulWidget {
  final String? userEmail;
  const UserChangePersonalSetting({super.key, required this.userEmail});

  @override
  State<UserChangePersonalSetting> createState() =>
      UserChangePersonalSettingState();
}

class UserChangePersonalSettingState extends State<UserChangePersonalSetting> {
  ...
  Future<void> _deleteAssessments() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Assessments deleted successfully!'),
      ),
    );
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              ElevatedButton(
                onPressed: _deleteAssessments,
                style: ElevatedButton.styleFrom(backgroundColor: Colors.red),
                child: const Text('Delete Assessments',
                    style: TextStyle(color: Colors.white)),
              ),
            ],
          ),
